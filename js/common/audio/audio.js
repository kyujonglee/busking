...
function whenPaused() {
  ...
  $("#play")
    .removeClass("fas fa-play fa-lgg")
...
// 오디오 메뉴에 추가하기!!
const audioItemList = [
  { title: "심쿵해", writer: "aoa", data: "MyType.mp3", duration: "03:36" },
  {
    title: "트와이스",
    writer: "FANCY",
    data: "트와이스 - FANCY.mp3",
    duration: "03:22"
  },
  {
    title: "다비치",
    ...
    data:
      "다비치 (DAVICHI) - 너에게 못했던 내 마지막 말은.mp3",
    duration: "03:11"
  },
  { title: "위아래", writer: "aoa", data: "MyType.mp3", duration: "03:36" }
];
