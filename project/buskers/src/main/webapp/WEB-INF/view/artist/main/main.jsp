    ...
    <div class="busker-board">
      ...
      <article class="busker-board__row">
        <div class="board-row__notice">
          ...
          <span class="board-row__date"> 05-17 </span>
        </div>
        <div class="board-row__notice">
          <i class="fas fa-bullhorn"></i>
          <span class="board-row__content">
        ...
        <div class="board-row__notice">
          <i class="fas fa-bullhorn"></i>
          <span class="board-row__content"> 말씀드릴 사항이 있습니다. </span>
          <span class="board-row__date"> 03-17 </span>
        </div>
        <div class="board-row__posts">
          <span class="board-row__num">2</span>
          <span class="board-row__content">
            저번공연 너무 좋지 않았어요?? ditate! Lorem ipsum dolor sit amet
            consectetur, adipisicing elit. Aliquid ratione ab sint quaerat ea
            eaque dolores distinctio facere sequi, ipsam recusandae assumenda,
            vitae id hic a tempore expedita ipsa non?
          </span>
          <span class="board-row__date"> 05-12 </span>
        </div>
        <div class="board-row__posts">
        ...
        <div class="board-row__posts">
          ...
          <span class="board-row__content"> 얼른 다시 뵙고싶어요!! </span>
          <span class="board-row__date"> 05-12 </span>
        </div>
        <div class="board-row__posts">
          <span class="board-row__num">15</span>
          <span class="board-row__content">
            얼른 다시 뵙고싶어요!! <span class="board-row__cnt">[122]</span>
          </span>
          <span class="board-row__date"> 05-12 </span>
        </div>
        <div class="board-row__posts">
  ...
  <div class="busker-audio-wrapper">
    ...
    <div class="music-box">
      <div class="music-box__imgbox">
        <img
          src="
      		<c:if test='${audioList[0].imgPath ne null}'>
	      		<c:url value='/file/download.do?path='/>${audioList[0].imgPath}
      		</c:if>
      		<c:if test='${audioList[0].imgPath ne null}'></c:if>
      	"
    ...
    <div class="busker-audio">
      ...
      <audio id="myAudio" loop="loop">
        ...
        <!--             type="audio/mpeg" -->
        <!--           /> -->
        <source src="${audioList[0].path}" type="audio/mpeg" />
      </audio>
